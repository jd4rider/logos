...
var speakCmd = &cobra.Command{
	...
	Long: `Speak a Bible verse or chapter using the shared Logos TTS engine.
  ...
  logos speak JHN.3.16`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		if !ttsEngine.Available() {
			return fmt.Errorf("no TTS engine available (install Kokoro or Piper, or use macOS say / Windows speech / Linux eSpeak)")
		}
